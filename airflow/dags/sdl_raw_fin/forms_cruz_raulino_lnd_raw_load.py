...
with DAG(
    dag_id="forms_cruz_raulino_lnd_raw_load",
    ...
    forms_cruz_raulino_lnd_raw_load = SSHOperator(
        task_id="forms_cruz_raulino_lnd_raw_load_task",
        ssh_conn_id="ssh_spark",
        command="""
            set -e
            echo "🚀 Iniciando a extração dos dados financeiros da planilha compartilhaada da landing para raw, via Spark"
            ...
            /opt/spark/bin/spark-submit \
              ...
              /opt/spark-jobs/jobs/sdl_raw_fin/forms_cruz_raulino_lnd_raw_load.py \
    ...
    forms_cruz_raulino_lnd_raw_load
